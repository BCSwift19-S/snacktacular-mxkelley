...
//        addressField.text = spot.address
    ...
    func saveCancelAlert(title: String, message: String, segueIdentifer: String) {
    ...
    @IBAction func photoButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This Venue Has Not Been Saved", message: "You must save this venue before you can add a photo.", segueIdentifer: "AddPhoto")
        } else {
    ...
    @IBAction func reviewButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This Venue Has Not Been Saved", message: "You must save this venue before you can review it.", segueIdentifer: "AddReview")
        } else {
